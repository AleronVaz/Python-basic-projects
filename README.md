...
Welcome to my repository of Python projects. This repository is a collection of programs that I am creating during my time learning python. Feel free to try these projects if you're a begineer & want to practice.
...
Implemeted Discount calculation system depending on users membership card using OOP.
...
1. **Clone the repository:**
   `git clone https://github.com/AleronVaz/Python-basic-projects.git` 

2. **Run the script:**
   Navigate to the folder and execute the .py programs
